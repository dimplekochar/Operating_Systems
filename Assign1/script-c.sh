...
then
	...
	g++ $shell_source -o $shell  &>/dev/null	#$shell is name of the executable
	if [ ! -e $shell ]
	then
...
g++ ./never_ending.c -o never_ending1
g++ ./never_ending.c -o never_ending2
g++ ./never_ending.c -o never_ending3
g++ ./never_ending.c -o never_ending4
